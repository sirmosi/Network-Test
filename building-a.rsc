...
add name=lobridge
/interface vrrp
add interface=ether3 name=vrrp1 priority=100 vrid=50
add interface=ether4 name=vrrp2 priority=100 vrid=60
/routing ospf area
...
/ip address
add address=10.10.1.2/24 interface=ether3 network=10.10.1.0
add address=10.10.1.100 interface=vrrp1 network=10.10.1.100
add address=10.20.1.100 interface=vrrp2 network=10.20.1.100
add address=10.20.1.2/24 interface=ether4 network=10.20.1.0
add address=172.16.1.100/24 interface=ether5 network=172.16.1.0
add address=172.16.2.100/24 interface=ether6 network=172.16.2.0
